...
import {DivSignUpForm, Input, H2, Label, DivLine, LabelCheck, InputCheck, InputBtn, P, A} from "./sign-up-style";
...
const SignUp = () => {
    ...
    const onSubmit: SubmitHandler<IFormInputs> = data => {
        api.signUp(data.username,data.email,data.password)
        ...
        <>
            <Section>
                <DivSignUpForm onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Label> Username
                        <Input type={"text"} error={errors.username} placeholder={'Username'} {
                            ...register("username",
                                {
                                    required: true,
                                    pattern: {
                    ...
                    <Label> Email address
                        <Input type={"text"} error={errors.email} placeholder={'Email address'} {
                            ...register("email",
                                {
                                    required: true,
                                    pattern: {
                    ...
                    <Label> Password
                        <Input type={"password"} error={errors.password} placeholder={'Password'} {
                            ...register("password",
                                {
                                    required: true,
                                    pattern: {
                    ...
                    <Label> Repeat password
                        <Input type={"password"} placeholder={'Repeat password'} error={errors.repeatPassword} {
